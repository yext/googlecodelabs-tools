...
import (
	...
	"github.com/atavakoliyext/googlecodelabs-tools/claat/v2/cmd"
	"github.com/atavakoliyext/googlecodelabs-tools/claat/v2/parser"

	// allow parsers to register themselves
	_ "github.com/atavakoliyext/googlecodelabs-tools/claat/v2/parser/gdoc"
	_ "github.com/atavakoliyext/googlecodelabs-tools/claat/v2/parser/md"
)
